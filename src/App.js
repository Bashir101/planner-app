...
function App() {
  const [widgets, setWidgets] = useState([
    ...
    { id: new Date().getTime() + 4, component: <PhotoWidget />, area: 'main-widget', name: 'Photo' },
    { id: new Date().getTime() + 5, component: <StopwatchWidget />, area: 'left-widget', name: 'Stopwatch' },
    { id: new Date().getTime() + 6, component: <CalculatorWidget />, area: 'right-widget', name: 'Calculator' },
  ]);
